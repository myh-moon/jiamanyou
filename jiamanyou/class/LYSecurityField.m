...
- (void)steup
{
    ...
    [self addTarget:self action:@selector(hangdleAction:) forControlEvents:UIControlEventAllEvents];
...
- (CALayer *)createSeparaterLine
{
    ...
    layer.backgroundColor = JLightGrayColor9.CGColor;
//    self.tintColor.CGColor ? self.tintColor.CGColor : self.layer.borderColor;
    return layer;
}
